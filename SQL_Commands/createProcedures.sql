...
CREATE PROCEDURE insert_product(IN catprod INT, IN naame VARCHAR(30), IN price DECIMAL(7, 2), IN avalible_count INT, IN discount INT)
BEGIN
	INSERT INTO product(product_id, categoryprod_id, `name`, price, availible_count, discount) VALUES (NULL, catprod, naame, price, avalible_count, discount);
END //
...
BEGIN
	INSERT INTO deliveryadress(adress_id, country, city, street, building_number, apartament, postal_code) VALUES (NULL,  country, city, street, building_nr, apartament, postal_code);
END //
...
BEGIN
	INSERT INTO customer(customer_id, adress_id, `name`, last_name, e_mail, `password`, phone, system_rank) VALUES (NULL, adress_id, naame, last_name, e_mail, paassword, phone, system_rank);
END //
